...
# Function to extract LaTeX expressions between $ symbols
def extract_latex(text):
    latex_expressions = re.findall(r'\$([^$]+)\$', text)
    return ['$' + exp + '$' for exp in latex_expressions]
...
output_file = './latex_expressions4.txt'  # Update with the path to the output file

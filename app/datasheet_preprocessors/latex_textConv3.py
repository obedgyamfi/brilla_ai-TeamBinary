...
# Conversion dictionary with doubled backslashes
conversion_dict = {
    ...
    r'\\left': '',
    r'\\right': '',
    r'\\mathrm\{([^\}]+)\}': r'\1',  # Corrected pattern
    r'\\begin': '',
    r'\\text': '',
    r'\\end': '',
    r'\\quad': ' ',
...
def process_excel_file(input_file_path, output_file_path):
    ...
    print(f'Processing file: {os.path.basename(output_file_path)}')
...
# File paths
input_file_path = '../ai_models_and_data/models_and_data/nsmq_past_questions/NSMQ QUESTIONS SPREADSHEETS/2020/2020 NSMQ contest 1.xlsx'
output_file_path = '../ai_models_and_data/models_and_data/nsmq_past_questions/NSMQ QUESTIONS SPREADSHEETS/2020/2020 NSMQ contest 1_modified.xlsx'
